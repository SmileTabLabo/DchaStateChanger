...
このバージョンはテストされていません。動作しない場合はREADMEv1.mdをご覧ください。
...
２0，設定トップ画面に戻り、以下のように開発者向けオプションを有効にします。

設定→システム→タブレット情報→ビルド番号連打

２1，ホーム画面に戻り、スタートボタンを押します。
...
※ユーザー情報入力画面、パスワード要求やエラーが出た場合は設定にミスがあります。戻って確認してください。
